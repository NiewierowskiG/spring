...
class PostResourceIT {
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).creationTime(UPDATED_CREATION_TIME).status(UPDATED_STATUS);
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).creationTime(UPDATED_CREATION_TIME).status(UPDATED_STATUS);
